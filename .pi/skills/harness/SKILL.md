...
11. For model/team/research/setup questions, prefer the adopted harness setup command (`.../bin/pi-harness setup --interactive` in local mode, `npm run harness:setup` in repo mode) and its generated local prompts/cheatsheet instead of separate setup commands or hand-written notes.
