...
- Added local/repo Pi wrapper and isolated Pi state directories.
...
- Pinned harness-root Pi CLI via reviewed vendored tarball and explicit manual approval.
- Added local-only and repo-contained adoption modes, pnpm-first setup, bootstrap/readiness UX, capability wizard UX, and CI gate scaffold.
